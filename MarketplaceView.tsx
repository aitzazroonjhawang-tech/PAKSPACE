    ...
    <div className={`flex select-none items-center ${horizontal ? 'flex-row gap-2.5' : 'flex-col justify-center text-center'}`}>
      <div className="relative flex items-center justify-center shrink-0">
        ...
        >
          ...
          <rect x="4" y="4" width="92" height="92" rx="14" fill="#FACC15" />
          ...
          <g transform="rotate(-4 50 50)">
            ...
            <path d="M33 77 C33 80.5 32 84 31.3 86.5 C31 87.6 32.6 88 33 87 C34 84 34.3 80 34 77 Z" fill="#3B82F6" />
            <path d="M63 58.5 C64 61.5 64.6 64 63.8 66 C63.4 67 61.9 66.8 62 65.6 C62.2 63 62 60.5 61.3 58.6 Z" fill="#3B82F6" />
            {/* a couple of stray spray specks */}
            <circle cx="76" cy="46" r="1.8" fill="#3B82F6" />
            <circle cx="27" cy="66" r="1.3" fill="#3B82F6" />
          </g>
        </svg>
      </div>
      ...
      {showText && (
        <div className={`font-serif tracking-tight font-bold ${horizontal ? '' : 'mt-2'} ${textSizeClass} ${textClassName}`}>
          <span className="text-[#3B82F6]">PakSpace</span>
        </div>
      )}
    </div>
  );
